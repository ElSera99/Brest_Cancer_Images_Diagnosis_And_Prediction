...
def image_proccess(path_R_full, path_R_ROI, data):
    ...
    for path in path_R_ROI:
        ...
        # imgOut = ImagenInteres[y:y+h, x:x+w]
...
# patient_right_cc_PI = patient_right_cc_PI[200:202] # corremos solo 3 datos porque es tardado procesar todo
...
# patient_left_cc_PI = patient_left_cc_PI[200:202] 
...
# Guarda datos en CSV:
df.to_csv('Caracteristicas_CC.csv', header=True, index=False)
